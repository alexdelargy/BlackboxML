...
class CustomModel:
    ...
    def __init__(self, df, taskType, modelType, x_features, y_feature, scalerType, encoderType, nullHandlerNumeric, nullHandlerCategorical):
        self.df = df
    ...
    def generateModel(self, modelType='linear'):
        if modelType == 'Linear':
    ...
    def trainModel(self):
        ...
        self.model = self.generateModel(modelType=self.modelType)
